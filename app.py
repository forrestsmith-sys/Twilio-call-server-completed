...
# ======================
# VOICEMAIL STORAGE (RENDER SAFE)
# ======================
VOICEMAIL_DIR = os.path.join(app.root_path, "static", "voicemails")
...
def handle_menu():
    ...
    if choice == "1":
        d = Dial(
            ...
            recordingStatusCallback="/call-recording-ready",
...
# ======================
# TRANSCRIPTION CALLBACK (CRITICAL)
# ======================
...
# ======================
@app.route("/voicemails/<path:filename>")
